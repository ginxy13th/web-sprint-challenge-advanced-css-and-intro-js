...
it makes it so that people with impairments can still access the page and navigate it 

2. Talk about 3 different things you can do to ensure your website is accessible.

alt tags, color scheme, responsive designs

3. How would you explain the concept of a variable to someone new to programming?

a placeholder with a value

4. What is the purpose of using functions in code?

to tell the code to do something within the code such as searching for an object
